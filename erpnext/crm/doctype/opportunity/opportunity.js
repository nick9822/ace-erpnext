...
erpnext.crm.Opportunity = frappe.ui.form.Controller.extend({
	...
	setup_queries: function() {
		...
		this.frm.set_query("customer", function() {
			return {filters: { owner: "avantika@aceid.ae" } };			
		});
...
cur_frm.cscript.refresh = function(doc, cdt, cdn) {
	...
	if(frm.perm[0].write && doc.docstatus==0) {
		if(frm.doc.status==="Open") {
			frm.add_custom_button(__("Start Estimation"), function() {
				frm.set_value("status", "Estimation");
				frm.set_value("estimation", 1);	
				cur_frm.save();
			});
		}
	}
...
=======
>>>>>>> 27334c28a984f79d303c8fe2aee9120de89235a6
